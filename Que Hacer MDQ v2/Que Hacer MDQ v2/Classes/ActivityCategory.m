    ...
    if (self=[super init])
    {
        ...
        switch (categoryId)
        {
            case 1:
                ...
                self.imageOriginFileName = @"art_category_roundbutton_outdoors_origin.png";
            ...
            case 2:
                ...
                self.imageOriginFileName = @"art_button_plastic-arts_origin";
                self.name = @"Arte y Cultura";
                self.tagId = [NSNumber numberWithInt:20];
                break;
            case 3:
                self.imageFileName = @"art_category_roundbutton_casino.png";
                 self.imageOriginFileName = @"art_category_roundbutton_casino_origin.png";
            ...
            case 4:
                ...
                self.imageOriginFileName = @"art_category_roundbutton_sportActivities_origin.png";
            ...
            case 5:
                ...
                self.imageOriginFileName = @"art_category_roundbutton_sports_origin.png";
            ...
            case 7:
                self.imageFileName = @"art_category_roundbutton_expo1.png";
                 self.imageOriginFileName = @"art_category_roundbutton_expo1_origin.png";
            ...
            case 8:
                self.imageFileName = @"art_category_roundbutton_party.png";
                 self.imageOriginFileName = @"art_category_roundbutton_party_origin.png";
            ...
            case 9:
                self.imageFileName = @"art_category_roundbutton_kids.png";
                  self.imageOriginFileName = @"art_category_roundbutton_kids_origin.png";
            ...
            case 10:
                ...
                self.imageOriginFileName = @"art_category_roundbutton_books_origin.png";
            ...
            case 11:
                ...
                self.imageOriginFileName = @"art_category_roundbutton_nightlife_origin.png";
            ...
            case 12:
                ...
                self.imageOriginFileName = @"art_category_roundbutton_family_origin.png";
            ...
            case 13:
                self.imageFileName = @"art_category_roundbutton_waterpark.png";
                 self.imageOriginFileName = @"art_category_roundbutton_waterpark_origin.png";
            ...
            case 14:
                ...
                self.imageOriginFileName = @"art_category_roundbutton_beach01_origin.png";
            ...
            case 15:
                self.imageFileName = @"art_category_roundbutton_rockConcert.png";
                 self.imageOriginFileName = @"art_category_roundbutton_rockConcert_origin.png";
            ...
            case 16:
                ...
                self.imageOriginFileName = @"art_category_roundbutton_theatre_origin.png";
            ...
            default:
                ...
                self.imageOriginFileName = @"art_category_roundbutton_AppLogo.png";
